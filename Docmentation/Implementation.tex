...
Next a preexisitng test from r was used to find results on realistic data. This data was tested with the python implementation and the results compared. Variables from the alarm_10000 dataset were used. many tests with different variables and conditioning sets were used
